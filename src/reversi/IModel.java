...
public interface IModel {
	/**
	 * Initialise the board to a specified size, and store references to the view
	 * and controller. Note that the basic model doesn't use these references!
	 * 
	...
	/**
	 * Only used by controllers which have a concept of current player. Set the
	 * current player number - if the controller uses a concept of player number.
	 * 
	...
	/**
	 * Only used by controllers which have a concept of current player. Get the
	 * current player number - if the controller uses a concept of player number.
	 * 
